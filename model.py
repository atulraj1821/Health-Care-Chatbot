...
from tensorflow.keras.layers import Dense, Activation, Dropout,Embedding,LSTM,Bidirectional
...
model.save('models/chat_model.h5', history)

print("model created")

## printing  accuracy  and loss
print("The loss is",history.history['loss'])
print("The aacuracy is",history.history['accuracy'])



## Getting  Performance Graph
